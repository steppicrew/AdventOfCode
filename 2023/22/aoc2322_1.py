...
def run() -> int:
    ...
    def occupy(brick: Brick, z: int | None = None):
        x = brick[0][0]
        y = brick[0][1]
        if z is None:
            z = brick[0][2]
